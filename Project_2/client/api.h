...
/// Modifies a string size by adding at its end a number of null characters ('\0').
/// @param str The string to add the \0 to.
/// @param targetLength The target length for the modified string.
void addNullCharacters(char *str, size_t targetLength);

/// Writes to the given file descriptor the list of the existinf events.
/// @param out_fd The file descriptor to write to.
/// @param num_events The number of existing events.
/// @param events The array of the event IDs.
